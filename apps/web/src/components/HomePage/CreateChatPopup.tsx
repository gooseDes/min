...
function CreateChatPopup(props: CreateChatPopupProps) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} type="button" onClick={closeCreateChatPopup}>
          <Icon icon={faArrowLeft} size={24} />
        </motion.button>
        <input type="text" placeholder={t.username_placeholder} value={username} onChange={e => setUsername(e.target.value)} />
